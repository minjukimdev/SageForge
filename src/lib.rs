...
#[derive(Debug)]
pub struct SageForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SageForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SageForge processing");
    
    let mut processor = SageForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SageForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SageForgeProcessor::new(false);
